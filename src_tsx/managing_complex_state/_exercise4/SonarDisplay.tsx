...
import {
  ...
  ColorContext,
  SetColorContext,
} from "../_exercise3/state/ColorContext"
import type { SonarAction } from "../_exercise1/state/SonarState"
...
const Sonar = ({ centerX, centerY, radius, whales, selectedWhale }: Props) => {
  ...
  const animals = whales.map((whale) => {
    const Icon = (
      <span
        ...
        onClick={() =>
          dispatchWhalesAction({ type: "setSelectedWhale", id: whale.id })
        }
      >
